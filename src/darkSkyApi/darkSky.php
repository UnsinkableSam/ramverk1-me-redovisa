...
class darkSky
{
    ...
    // public static function wheatherActionGet($res = null, $time = null, $accessKey = "9fe0ef6d3f7319dd6198b0b4584a1011") : string
    // {
    //
    //
    //
    //
    //       $curlh  = curl_init('https://api.darksky.net/forecast/'.$accessKey.'/'.$res->latitude .
    //       ','. $res->longitude . "," . $time. "?exclude=minutely?exclude=hourly");
